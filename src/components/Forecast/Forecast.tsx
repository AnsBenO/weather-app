...
const Forecast: React.FC = () => {
    ...
    return (
        <>
            {
                data && <div className="forecast-div">
                                ...
                                <AccordionItemHeading>
                                    <AccordionItemButton>
                                        <div className="hourly-item">
                                            <img src={`/weather-app/icons/${item.weather[0].icon}.png`} alt="weather" className="icon-small" draggable="false" />
                                ...
                                <AccordionItemPanel>
                                    <div className="hourly-detail-grid">
                                        ...
                                        <div className="hourly-detail-grid-item">
                                            ...
                                            <label>{(item.visibility / 1000).toFixed(2)} km</label>
                                        </div>
                                        <div className="hourly-detail-grid-item">
